...
<div v-if="plan">
    ...
    <avue-form ref="form" :option="optionView" v-model="viewData"/>
<br/>
    ...
    <avue-crud :option="option"
            ...
            <el-button type="danger" size="mini">繁 忙</el-button>
        </template>
...
<script>
  import {getList, getDetail, add, update, remove} from "../teamTruck/api.js";
  import optionView from "./const-view.js";
  import option from "./const-truck-edit.js";
  ...
  export default {
    ...
    mounted(){
      this.viewData = {...this.plan}
      this.viewData.truckCount = this.plan.truckList.length
    ...
    methods: {
      ...
      onLoad(page, params = {}) {
        ...
        this.query.teamId = this.plan.id
        this.loading = true;
